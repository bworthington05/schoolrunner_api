...
public class UnalignedAssessmentComparison {
  ...
  public String run() {
    ...
    String csvFileName = "/home/ubuntu/workspace/output/data_digest/Unaligned_Assessments_" +
      this.minDate + "-" + this.maxDate + ".csv";
      
    String chartFileNameString = "/home/ubuntu/workspace/output/data_digest/Unaligned_Assessments_" +
  ...
  //method to make a .csv list of the specific assessments that are missing objectives
  //this is very similar to the SQL query in the AssessmentsWithoutObjectives class that emails teachers
  //make sure to do the run() method of this class first so that database is ready
  public String getUnalignedAssessmentsCSV() {
    
    //file path for .csv to be saved
    String csvFileName = "/home/ubuntu/workspace/output/data_digest/Unaligned_Assessment_List_" +
      this.minDate + "-" + this.maxDate + ".csv";
    ...
    try {
      ...
      String query = (
        ...
        "WHERE assessments.sr_school_id != '5' " +
            //don't include assessments with 0 results
  ...
  } //end getUnalignedAssessmentsCSV method
